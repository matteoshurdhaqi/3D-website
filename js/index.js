...
function update(cursorPosition){
    parallax_el.forEach((el) => {
        ...
        // el.style.transform = `translateX(calc(-50% + ${-xValue * speedx}px)) rotateX(${rotateDegree * rotateSpeed}deg) translateY(calc(-50% + ${yValue * speedy}px)) perspective(2300px) translateZ(${zValue * speedz}px)`;
